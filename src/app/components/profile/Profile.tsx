              ...
              <div className="mt-8 flex flex-col justify-center items-center gap-3">
                <div className="flex items-center gap-3">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-telephone-fill fill-text-muted"
                    viewBox="0 0 16 16"
                  >
                    <path
                      fillRule="evenodd"
                  ...
                  <span className="text-text-muted">{data.phone}</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-envelope-at-fill fill-text-muted"
                    viewBox="0 0 16 16"
                  >
                  ...
                  <span className="text-text-muted">{data.email}</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="bi bi-geo-alt-fill fill-text-muted"
                    viewBox="0 0 16 16"
                  >
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                  </svg>

                  <span className="text-text-muted">{data.location}</span>
                </div>
              </div>
